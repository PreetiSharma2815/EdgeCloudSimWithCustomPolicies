...
public class SampleScenarioFactory6 implements ScenarioFactory {
	private int numOfMobileDevice;
	private double simulationTime;
	private String orchestratorPolicy;
	private String simScenario;
	
	SampleScenarioFactory6(int _numOfMobileDevice,
	...
	public EdgeOrchestrator getEdgeOrchestrator() {
		return new SampleEdgeOrchestrator6(orchestratorPolicy, simScenario);
	}
